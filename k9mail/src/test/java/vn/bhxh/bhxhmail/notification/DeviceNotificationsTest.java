...
import static vn.bhxh.bhxhmail.MockHelper.mockBuilder;
...
public class DeviceNotificationsTest {
    ...
    public void buildSummaryNotification_withPrivacyModeActive() throws Exception {
        ...
        verify(builder).setSmallIcon(vn.bhxh.bhxhmail.R.drawable.notification_icon_new_mail);
    ...
    public void buildSummaryNotification_withSingleMessageNotification() throws Exception {
        ...
        verify(builder).addAction(vn.bhxh.bhxhmail.R.drawable.notification_action_reply, "Reply", null);
        verify(builder).addAction(vn.bhxh.bhxhmail.R.drawable.notification_action_mark_as_read, "Mark Read", null);
        verify(builder).addAction(vn.bhxh.bhxhmail.R.drawable.notification_action_delete, "Delete", null);
        verify(lockScreenNotification).configureLockScreenNotification(builder, notificationData);
        assertEquals(FAKE_NOTIFICATION, result);
    }
    ...
    public void buildSummaryNotification_withoutDeleteAllAction() throws Exception {
        ...
        verify(builder, never()).addAction(vn.bhxh.bhxhmail.R.drawable.notification_action_delete, "Delete", null);
    }
