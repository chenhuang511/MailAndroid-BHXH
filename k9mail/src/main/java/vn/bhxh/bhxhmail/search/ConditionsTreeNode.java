...
public class ConditionsTreeNode implements Parcelable {
    ...
    private static ConditionsTreeNode buildNodeFromRow(Cursor cursor) {
        ...
        if (tmpValue == Operator.CONDITION) {
            condition = new SearchSpecification.SearchCondition(SearchSpecification.SearchField.valueOf(cursor.getString(0)),
                    SearchSpecification.Attribute.valueOf(cursor.getString(2)), cursor.getString(1));
        }
