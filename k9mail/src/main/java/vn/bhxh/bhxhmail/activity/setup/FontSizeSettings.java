...
public class FontSizeSettings extends K9PreferenceActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(vn.bhxh.bhxhmail.R.xml.font_preferences);
        ...
        final String summaryFormat = getString(vn.bhxh.bhxhmail.R.string.font_size_message_view_content_summary);
        final String titleFormat = getString(vn.bhxh.bhxhmail.R.string.font_size_message_view_content_dialog_title);
