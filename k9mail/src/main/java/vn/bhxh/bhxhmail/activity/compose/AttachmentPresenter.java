...
import vn.bhxh.bhxhmail.activity.loader.AttachmentContentLoader;
import vn.bhxh.bhxhmail.activity.loader.AttachmentInfoLoader;
...
public class AttachmentPresenter {
    private static final String STATE_KEY_ATTACHMENTS = "MessageCompose.attachments";
