...
import vn.bhxh.bhxhmail.service.DatabaseUpgradeService;
 ...
 *     {@link SharedPreferences} file to {@link LocalStore#DB_VERSION}. This
...
public class UpgradeDatabases extends K9Activity {
    ...
    private void initializeLayout() {
        setContentView(vn.bhxh.bhxhmail.R.layout.upgrade_databases);

        mUpgradeText = (TextView) findViewById(vn.bhxh.bhxhmail.R.id.databaseUpgradeText);
    }
    ...
    class UpgradeDatabaseBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, final Intent intent) {
            ...
            if (DatabaseUpgradeService.ACTION_UPGRADE_PROGRESS.equals(action)) {
                ...
                if (account != null) {
                    String formatString = getString(vn.bhxh.bhxhmail.R.string.upgrade_database_format);
