...
public class ChooseIdentity extends K9ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(vn.bhxh.bhxhmail.R.layout.list_content_simple);
    ...
    protected void refreshView() {
        ...
        for (Identity identity : identities) {
            ...
            if (description == null || description.trim().isEmpty()) {
                description = getString(vn.bhxh.bhxhmail.R.string.message_view_from_format, identity.getName(), identity.getEmail());
            }
        ...
        this.getListView().setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (email != null && !email.trim().equals("")) {
                    ...
                    Toast.makeText(ChooseIdentity.this, getString(vn.bhxh.bhxhmail.R.string.identity_has_no_email),
