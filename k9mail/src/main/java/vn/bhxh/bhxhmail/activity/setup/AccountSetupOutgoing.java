...
public class AccountSetupOutgoing extends K9Activity implements OnClickListener,
    ...
    public static void actionOutgoingSettings(Context context, Account account, boolean makeDefault, AccountExtras accountExtras) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(vn.bhxh.bhxhmail.R.layout.account_setup_outgoing);
        ...
        mRequireLoginView = (CheckBox)findViewById(vn.bhxh.bhxhmail.R.id.account_require_login);
        mRequireLoginSettingsView = (ViewGroup)findViewById(vn.bhxh.bhxhmail.R.id.account_require_login_settings);
    ...
    private void setInputLogin() {
        ...
        mServerView.setText(mAccountExtras.getSmtpServer());
        mUsernameView.setText(mAccountExtras.getSmtpUserName());
        mPasswordView.setText(mAccountExtras.getSmtpPass());
    ...
    private void validateFields() {
        ...
        if (isAuthTypeExternal && !hasConnectionSecurity) {
            ...
            String toastText = getString(vn.bhxh.bhxhmail.R.string.account_setup_outgoing_invalid_setting_combo_notice,
