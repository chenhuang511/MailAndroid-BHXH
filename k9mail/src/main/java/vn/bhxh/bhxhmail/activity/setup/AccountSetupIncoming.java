...
import vn.bhxh.bhxhmail.activity.setup.AccountSetupCheckSettings.CheckDirection;
...
import vn.bhxh.bhxhmail.mail.store.imap.ImapStoreSettings;
import vn.bhxh.bhxhmail.mail.store.webdav.WebDavStoreSettings;
...
public class AccountSetupIncoming extends K9Activity implements OnClickListener {
    ...
    public static void actionIncomingSettings(Activity context, Account account, boolean makeDefault, AccountExtras accountExtras) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(vn.bhxh.bhxhmail.R.layout.account_setup_incoming);

        mUsernameView = (EditText)findViewById(vn.bhxh.bhxhmail.R.id.account_username);
        ...
        mClientCertificateLabelView = (TextView)findViewById(vn.bhxh.bhxhmail.R.id.account_client_certificate_label);
        mPasswordLabelView = (TextView)findViewById(vn.bhxh.bhxhmail.R.id.account_password_label);
        TextView serverLabelView = (TextView) findViewById(vn.bhxh.bhxhmail.R.id.account_server_label);
        mServerView = (EditText)findViewById(vn.bhxh.bhxhmail.R.id.account_server);
        mPortView = (EditText)findViewById(vn.bhxh.bhxhmail.R.id.account_port);
        mSecurityTypeView = (Spinner)findViewById(vn.bhxh.bhxhmail.R.id.account_security_type);
        mAuthTypeView = (Spinner)findViewById(vn.bhxh.bhxhmail.R.id.account_auth_type);
        mImapAutoDetectNamespaceView = (CheckBox)findViewById(vn.bhxh.bhxhmail.R.id.imap_autodetect_namespace);
        mImapPathPrefixView = (EditText)findViewById(vn.bhxh.bhxhmail.R.id.imap_path_prefix);
        mWebdavPathPrefixView = (EditText)findViewById(vn.bhxh.bhxhmail.R.id.webdav_path_prefix);
        mWebdavAuthPathView = (EditText)findViewById(vn.bhxh.bhxhmail.R.id.webdav_auth_path);
        mWebdavMailboxPathView = (EditText)findViewById(vn.bhxh.bhxhmail.R.id.webdav_mailbox_path);
        mNextButton = (Button)findViewById(vn.bhxh.bhxhmail.R.id.next);
        mCompressionMobile = (CheckBox)findViewById(vn.bhxh.bhxhmail.R.id.compression_mobile);
        mCompressionWifi = (CheckBox)findViewById(vn.bhxh.bhxhmail.R.id.compression_wifi);
        mCompressionOther = (CheckBox)findViewById(vn.bhxh.bhxhmail.R.id.compression_other);
        mSubscribedFoldersOnly = (CheckBox)findViewById(vn.bhxh.bhxhmail.R.id.subscribed_folders_only);
        ...
        try {
            ...
            if (Type.POP3 == settings.type) {
                serverLabelView.setText(vn.bhxh.bhxhmail.R.string.account_setup_incoming_pop_server_label);
                findViewById(vn.bhxh.bhxhmail.R.id.imap_path_prefix_section).setVisibility(View.GONE);
                findViewById(vn.bhxh.bhxhmail.R.id.webdav_advanced_header).setVisibility(View.GONE);
                findViewById(vn.bhxh.bhxhmail.R.id.webdav_mailbox_alias_section).setVisibility(View.GONE);
                findViewById(vn.bhxh.bhxhmail.R.id.webdav_owa_path_section).setVisibility(View.GONE);
                findViewById(vn.bhxh.bhxhmail.R.id.webdav_auth_path_section).setVisibility(View.GONE);
                findViewById(vn.bhxh.bhxhmail.R.id.compression_section).setVisibility(View.GONE);
                findViewById(vn.bhxh.bhxhmail.R.id.compression_label).setVisibility(View.GONE);
                mSubscribedFoldersOnly.setVisibility(View.GONE);
            } else if (Type.IMAP == settings.type) {
                serverLabelView.setText(vn.bhxh.bhxhmail.R.string.account_setup_incoming_imap_server_label);
                ...
                if (!editSettings) {
                    findViewById(vn.bhxh.bhxhmail.R.id.imap_folder_setup_section).setVisibility(View.GONE);
                }
            } else if (Type.WebDAV == settings.type) {
                serverLabelView.setText(vn.bhxh.bhxhmail.R.string.account_setup_incoming_webdav_server_label);
                ...
                findViewById(vn.bhxh.bhxhmail.R.id.imap_path_prefix_section).setVisibility(View.GONE);
                findViewById(vn.bhxh.bhxhmail.R.id.account_auth_type_label).setVisibility(View.GONE);
                findViewById(vn.bhxh.bhxhmail.R.id.account_auth_type).setVisibility(View.GONE);
                findViewById(vn.bhxh.bhxhmail.R.id.compression_section).setVisibility(View.GONE);
                findViewById(vn.bhxh.bhxhmail.R.id.compression_label).setVisibility(View.GONE);
                mSubscribedFoldersOnly.setVisibility(View.GONE);
        ...
        mNextButton.postDelayed(new Runnable() {
            @Override
            public void run() {
                setInputLogin();
            }
    ...
    private void setInputLogin() {
        if(mAccountExtras == null){
            return;
        }
        mServerView.setText(mAccountExtras.getImapServer());
        mUsernameView.setText(mAccountExtras.getImapUserName());
        mPasswordView.setText(mAccountExtras.getImapPass());
    ...
    private void validateFields() {
        ...
        if (isAuthTypeExternal && !hasConnectionSecurity) {
            ...
            String toastText = getString(vn.bhxh.bhxhmail.R.string.account_setup_incoming_invalid_setting_combo_notice,
                    getString(vn.bhxh.bhxhmail.R.string.account_setup_incoming_auth_type_label),
                    AuthType.EXTERNAL.toString(),
                    getString(vn.bhxh.bhxhmail.R.string.account_setup_incoming_security_label),
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            if (Intent.ACTION_EDIT.equals(getIntent().getAction())) {
                ...
                AccountSetupOutgoing.actionOutgoingSettings(this, mAccount, mMakeDefault, mAccountExtras);
                finish();
            }
        }
    }
