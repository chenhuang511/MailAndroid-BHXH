...
import vn.bhxh.bhxhmail.Account.Searchable;
import vn.bhxh.bhxhmail.Account.ShowPictures;
import vn.bhxh.bhxhmail.K9;
import vn.bhxh.bhxhmail.NotificationSetting;
import vn.bhxh.bhxhmail.Preferences;
import vn.bhxh.bhxhmail.activity.ChooseFolder;
import vn.bhxh.bhxhmail.activity.ChooseIdentity;
import vn.bhxh.bhxhmail.activity.ColorPickerDialog;
import vn.bhxh.bhxhmail.activity.K9PreferenceActivity;
import vn.bhxh.bhxhmail.activity.ManageIdentities;
import vn.bhxh.bhxhmail.crypto.OpenPgpApiHelper;
...
public class AccountSettings extends K9PreferenceActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(vn.bhxh.bhxhmail.R.xml.account_settings_preferences);
        ...
        if (mHasCrypto) {
            ...
            mCryptoMenu.setSummary(vn.bhxh.bhxhmail.R.string.account_settings_no_openpgp_provider_installed);
        }
    }
    ...
    private String translateFolder(String in) {
        if (mAccount.getInboxFolderName().equalsIgnoreCase(in)) {
            return getString(vn.bhxh.bhxhmail.R.string.special_mailbox_name_inbox);
        } else {
            return in;
        }
    }
    ...
    private String reverseTranslateFolder(String in) {
        if (getString(vn.bhxh.bhxhmail.R.string.special_mailbox_name_inbox).equals(in)) {
    ...
    private void updateRemoteSearchLimit(String maxResults) {
        if (maxResults != null) {
            if (maxResults.equals("0")) {
                maxResults = getString(vn.bhxh.bhxhmail.R.string.account_settings_remote_search_num_results_entries_all);
            }

            mRemoteSearchNumResults.setSummary(String.format(getString(vn.bhxh.bhxhmail.R.string.account_settings_remote_search_num_summary), maxResults));
        }
    }
