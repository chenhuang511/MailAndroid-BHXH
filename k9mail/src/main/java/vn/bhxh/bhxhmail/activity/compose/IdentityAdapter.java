    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item instanceof Account) {
            if (convertView != null && convertView.getTag() instanceof AccountHolder) {
                ...
                view = mLayoutInflater.inflate(vn.bhxh.bhxhmail.R.layout.choose_account_item, parent, false);
                AccountHolder holder = new AccountHolder();
                holder.name = (TextView) view.findViewById(vn.bhxh.bhxhmail.R.id.name);
            ...
            if (convertView != null && convertView.getTag() instanceof IdentityHolder) {
                ...
                view = mLayoutInflater.inflate(vn.bhxh.bhxhmail.R.layout.choose_identity_item, parent, false);
