...
import vn.bhxh.bhxhmail.mail.power.TracingPowerManager.TracingWakeLock;

public class SleepService extends CoreService {

    private static String ALARM_FIRED = "SleepService.ALARM_FIRED";
    private static String LATCH_ID = "SleepService.LATCH_ID_EXTRA";
