...
import vn.bhxh.bhxhmail.ui.messageview.OnCryptoClickListener;
...
public class MessageHeader extends LinearLayout implements OnClickListener, OnLongClickListener {
    ...
    protected void onFinishInflate() {
        ...
        mAnsweredIcon = findViewById(vn.bhxh.bhxhmail.R.id.answered);
        mForwardedIcon = findViewById(vn.bhxh.bhxhmail.R.id.forwarded);
        mFromView = (TextView) findViewById(vn.bhxh.bhxhmail.R.id.from);
        mToView = (TextView) findViewById(vn.bhxh.bhxhmail.R.id.to);
        mToLabel = (TextView) findViewById(vn.bhxh.bhxhmail.R.id.to_label);
        mCcView = (TextView) findViewById(vn.bhxh.bhxhmail.R.id.cc);
        mCcLabel = (TextView) findViewById(vn.bhxh.bhxhmail.R.id.cc_label);

        mContactBadge = (QuickContactBadge) findViewById(vn.bhxh.bhxhmail.R.id.contact_badge);

        mSubjectView = (TextView) findViewById(vn.bhxh.bhxhmail.R.id.subject);
        mAdditionalHeadersView = (TextView) findViewById(vn.bhxh.bhxhmail.R.id.additional_headers_view);
        mChip = findViewById(vn.bhxh.bhxhmail.R.id.chip);
        mDateView = (TextView) findViewById(vn.bhxh.bhxhmail.R.id.date);
        mFlagged = (CheckBox) findViewById(vn.bhxh.bhxhmail.R.id.flagged);
        ...
        mCryptoStatusIcon = (MessageCryptoStatusView) findViewById(vn.bhxh.bhxhmail.R.id.crypto_status_icon);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case vn.bhxh.bhxhmail.R.id.from: {
//                hainv edited
//                onAddSenderToContacts();
            ...
            case vn.bhxh.bhxhmail.R.id.crypto_status_icon: {
    ...
    public String createMessage(int addressesCount) {
        return mContext.getResources().getQuantityString(vn.bhxh.bhxhmail.R.plurals.copy_address_to_clipboard, addressesCount);
    }
    ...
    private void showAdditionalHeaders() {
        ...
        try {
            ...
            if (!additionalHeaders.isEmpty()) {
                ...
                messageToShow = vn.bhxh.bhxhmail.R.string.message_no_additional_headers_available;
            }
        } catch (Exception e) {
            messageToShow = vn.bhxh.bhxhmail.R.string.message_additional_headers_retrieval_failed;
        }
    ...
    public void populate(final Message message, final Account account) {
        ...
        if (TextUtils.isEmpty(subject)) {
            mSubjectView.setText(mContext.getText(vn.bhxh.bhxhmail.R.string.general_no_subject));
        } else {
        ...
        if (K9.showContactPicture()) {
            if (counterpartyAddress != null) {
                ...
                mContactBadge.setImageResource(vn.bhxh.bhxhmail.R.drawable.ic_contact_picture);
            }
        }
