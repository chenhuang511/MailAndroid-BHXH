...
public class ClientCertificateSpinner extends LinearLayout {
    ...
    public ClientCertificateSpinner(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(vn.bhxh.bhxhmail.R.layout.client_certificate_spinner, this, true);

        mSelection = (Button) findViewById(vn.bhxh.bhxhmail.R.id.client_certificate_spinner_button);
        ...
        mDeleteButton = (ImageButton) findViewById(vn.bhxh.bhxhmail.R.id.client_certificate_spinner_delete);
    ...
    public String getAlias() {
        ...
        if (alias.equals(mActivity.getString(vn.bhxh.bhxhmail.R.string.client_certificate_spinner_empty))) {
            return null;
        } else {
            return alias;
        }
    ...
    private void updateView() {
        if (mAlias != null) {
            ...
            mSelection.setText(vn.bhxh.bhxhmail.R.string.client_certificate_spinner_empty);
        }
    }
