...
public class CryptoModeSelector extends FrameLayout implements OnSeekBarChangeListener {
    ...
    public void init() {
        inflate(getContext(), vn.bhxh.bhxhmail.R.layout.crypto_mode_selector, this);
        seekbar = (SeekBar) findViewById(vn.bhxh.bhxhmail.R.id.seek_bar);
        modeIcon2 = (ImageView) findViewById(vn.bhxh.bhxhmail.R.id.icon_2);
        modeIcon3 = (ImageView) findViewById(vn.bhxh.bhxhmail.R.id.icon_3);
        modeIcon4 = (ImageView) findViewById(vn.bhxh.bhxhmail.R.id.icon_4);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        int grey = ThemeUtils.getStyledColor(getContext(), vn.bhxh.bhxhmail.R.attr.openpgp_grey);
        ...
        crossfadedColor = crossfadeColor(grey, ThemeUtils.getStyledColor(getContext(), vn.bhxh.bhxhmail.R.attr.openpgp_blue), crossfadeValue2);
        modeIcon2.setColorFilter(crossfadedColor, PorterDuff.Mode.SRC_ATOP);

        crossfadedColor = crossfadeColor(grey, ThemeUtils.getStyledColor(getContext(), vn.bhxh.bhxhmail.R.attr.openpgp_orange), crossfadeValue3);
        modeIcon3.setColorFilter(crossfadedColor, PorterDuff.Mode.SRC_ATOP);

        crossfadedColor = crossfadeColor(grey, ThemeUtils.getStyledColor(getContext(), vn.bhxh.bhxhmail.R.attr.openpgp_green), crossfadeValue4);
