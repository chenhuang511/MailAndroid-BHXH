...
public class MessageCryptoStatusView extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        iconSingle = (ImageView) findViewById(vn.bhxh.bhxhmail.R.id.crypto_status_single);
        iconCombinedFirst = (ImageView) findViewById(vn.bhxh.bhxhmail.R.id.crypto_status_combined_1);
        iconCombinedSecond = (ImageView) findViewById(vn.bhxh.bhxhmail.R.id.crypto_status_combined_2);
        iconDotsBackground = (ImageView) findViewById(vn.bhxh.bhxhmail.R.id.crypto_status_dots_bg);
    }
