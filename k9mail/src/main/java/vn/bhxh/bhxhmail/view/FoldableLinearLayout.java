...
public class FoldableLinearLayout extends LinearLayout {
    ...
    private void processAttributes(Context context, AttributeSet attrs) {
        ...
        boolean found = theme.resolveAttribute(vn.bhxh.bhxhmail.R.attr.iconActionCollapse, outValue, true);
        if (found) {
            mIconActionCollapseId = outValue.resourceId;
        }
        found = theme.resolveAttribute(vn.bhxh.bhxhmail.R.attr.iconActionExpand, outValue, true);
        if (found) {
            mIconActionExpandId = outValue.resourceId;
        }
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs,
                    vn.bhxh.bhxhmail.R.styleable.FoldableLinearLayout, 0, 0);
            mFoldedLabel = a.getString(vn.bhxh.bhxhmail.R.styleable.FoldableLinearLayout_foldedLabel);
            mUnFoldedLabel = a.getString(vn.bhxh.bhxhmail.R.styleable.FoldableLinearLayout_unFoldedLabel);
            a.recycle();
        }
    ...
    private void migrateChildrenToContainer() {
        ...
        if (children[0].getId() == vn.bhxh.bhxhmail.R.id.foldableControl) {
        }
        ...
        mFoldableLayout = inflator.inflate(vn.bhxh.bhxhmail.R.layout.foldable_linearlayout, this, true);
        mFoldableContainer = (LinearLayout) mFoldableLayout.findViewById(vn.bhxh.bhxhmail.R.id.foldableContainer);
    ...
    private void initialiseInnerViews() {
        mFoldableIcon = (ImageView) mFoldableLayout.findViewById(vn.bhxh.bhxhmail.R.id.foldableIcon);
        mFoldableTextView = (TextView) mFoldableLayout.findViewById(vn.bhxh.bhxhmail.R.id.foldableText);
        ...
        LinearLayout foldableControl = (LinearLayout) mFoldableLayout
                .findViewById(vn.bhxh.bhxhmail.R.id.foldableControl);
