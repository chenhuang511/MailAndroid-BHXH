        ...
        if (quoteStyle == QuoteStyle.PREFIX) {
            ...
            if (sentDate.length() != 0) {
                header.append(HtmlConverter.textToHtmlFragment(String.format(
                        resources.getString(vn.bhxh.bhxhmail.R.string.message_compose_reply_header_fmt_with_date), sentDate, fromAddress)
                ));
            } else {
                header.append(HtmlConverter.textToHtmlFragment(String.format(
                        resources.getString(vn.bhxh.bhxhmail.R.string.message_compose_reply_header_fmt), fromAddress)
                ));
            }
            ...
            if (originalMessage.getFrom() != null && fromAddress.length() != 0) {
                header.append("<b>").append(resources.getString(vn.bhxh.bhxhmail.R.string.message_compose_quote_header_from)).append("</b> ")
                        .append(HtmlConverter.textToHtmlFragment(fromAddress))
                        .append("<br>\r\n");
            }
            if (sentDate.length() != 0) {
                header.append("<b>").append(resources.getString(vn.bhxh.bhxhmail.R.string.message_compose_quote_header_send_date)).append("</b> ")
                        .append(sentDate)
                        .append("<br>\r\n");
            }
            if (originalMessage.getRecipients(Message.RecipientType.TO) != null && originalMessage.getRecipients(Message.RecipientType.TO).length != 0) {
                header.append("<b>").append(resources.getString(vn.bhxh.bhxhmail.R.string.message_compose_quote_header_to)).append("</b> ")
                        .append(HtmlConverter.textToHtmlFragment(Address.toString(originalMessage.getRecipients(Message.RecipientType.TO))))
                        .append("<br>\r\n");
            }
            if (originalMessage.getRecipients(Message.RecipientType.CC) != null && originalMessage.getRecipients(Message.RecipientType.CC).length != 0) {
                header.append("<b>").append(resources.getString(vn.bhxh.bhxhmail.R.string.message_compose_quote_header_cc)).append("</b> ")
                        .append(HtmlConverter.textToHtmlFragment(Address.toString(originalMessage.getRecipients(Message.RecipientType.CC))))
                        .append("<br>\r\n");
            }
            if (originalMessage.getSubject() != null) {
                header.append("<b>").append(resources.getString(vn.bhxh.bhxhmail.R.string.message_compose_quote_header_subject)).append("</b> ")
        ...
        if (quoteStyle == QuoteStyle.PREFIX) {
            ...
            if (sentDate.length() != 0) {
                quotedText.append(String.format(
                        resources.getString(vn.bhxh.bhxhmail.R.string.message_compose_reply_header_fmt_with_date) + "\r\n",
                        sentDate,
                        Address.toString(originalMessage.getFrom())));
            } else {
                quotedText.append(String.format(
                        resources.getString(vn.bhxh.bhxhmail.R.string.message_compose_reply_header_fmt) + "\r\n",
                        Address.toString(originalMessage.getFrom()))
                );
            }
            ...
            StringBuilder quotedText = new StringBuilder(body.length() + QuotedMessageHelper.QUOTE_BUFFER_LENGTH);
            quotedText.append("\r\n");
            quotedText.append(resources.getString(vn.bhxh.bhxhmail.R.string.message_compose_quote_header_separator)).append("\r\n");
            if (originalMessage.getFrom() != null && Address.toString(originalMessage.getFrom()).length() != 0) {
                quotedText.append(resources.getString(vn.bhxh.bhxhmail.R.string.message_compose_quote_header_from)).append(" ").append(Address.toString(originalMessage.getFrom())).append("\r\n");
            }
            if (sentDate.length() != 0) {
                quotedText.append(resources.getString(vn.bhxh.bhxhmail.R.string.message_compose_quote_header_send_date)).append(" ").append(sentDate).append("\r\n");
            }
            if (originalMessage.getRecipients(Message.RecipientType.TO) != null && originalMessage.getRecipients(Message.RecipientType.TO).length != 0) {
                quotedText.append(resources.getString(vn.bhxh.bhxhmail.R.string.message_compose_quote_header_to)).append(" ").append(Address.toString(originalMessage.getRecipients(Message.RecipientType.TO))).append("\r\n");
            }
            if (originalMessage.getRecipients(Message.RecipientType.CC) != null && originalMessage.getRecipients(Message.RecipientType.CC).length != 0) {
                quotedText.append(resources.getString(vn.bhxh.bhxhmail.R.string.message_compose_quote_header_cc)).append(" ").append(Address.toString(originalMessage.getRecipients(Message.RecipientType.CC))).append("\r\n");
            }
            if (originalMessage.getSubject() != null) {
                quotedText.append(resources.getString(vn.bhxh.bhxhmail.R.string.message_compose_quote_header_subject)).append(" ").append(originalMessage.getSubject()).append("\r\n");
            }
            quotedText.append("\r\n");
