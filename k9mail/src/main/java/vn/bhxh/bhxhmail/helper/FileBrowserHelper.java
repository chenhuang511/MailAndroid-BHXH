...
public class FileBrowserHelper {
    ...
    private void showPathTextInput(final Activity c, final File startPath, final FileBrowserFailOverCallback callback) {
        ...
        alert.setTitle(c.getString(vn.bhxh.bhxhmail.R.string.attachment_save_title));
        alert.setMessage(c.getString(vn.bhxh.bhxhmail.R.string.attachment_save_desc));
        ...
        alert.setPositiveButton(c.getString(vn.bhxh.bhxhmail.R.string.okay_action), new DialogInterface.OnClickListener() {
        ...
        alert.setNegativeButton(c.getString(vn.bhxh.bhxhmail.R.string.cancel_action),
