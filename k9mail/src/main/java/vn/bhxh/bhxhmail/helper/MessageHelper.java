...
import vn.bhxh.bhxhmail.activity.MessageInfoHolder;
...
public class MessageHelper {
     ...
     * </p>
     *
     * @see #toFriendly(Address[], Contacts)
     */
    ...
    public void populate(final MessageInfoHolder target,
        ...
        if (addrs.length > 0 &&  account.isAnIdentity(addrs[0])) {
            ...
            target.sender = new SpannableStringBuilder(mContext.getString(vn.bhxh.bhxhmail.R.string.message_to_label)).append(to);
        } else {
    ...
    public CharSequence getDisplayName(Account account, Address[] fromAddrs, Address[] toAddrs) {
        ...
        if (fromAddrs.length > 0 && account.isAnIdentity(fromAddrs[0])) {
            ...
            displayName = new SpannableStringBuilder(
                    mContext.getString(vn.bhxh.bhxhmail.R.string.message_to_label)).append(to);
        } else {
