...
public class CryptoInfoDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialogView = LayoutInflater.from(getActivity()).inflate(vn.bhxh.bhxhmail.R.layout.message_crypto_info_dialog, null);

        topIconFrame = dialogView.findViewById(vn.bhxh.bhxhmail.R.id.crypto_info_top_frame);
        topIcon_1 = (ImageView) topIconFrame.findViewById(vn.bhxh.bhxhmail.R.id.crypto_info_top_icon_1);
        topIcon_2 = (ImageView) topIconFrame.findViewById(vn.bhxh.bhxhmail.R.id.crypto_info_top_icon_2);
        topIcon_3 = (ImageView) topIconFrame.findViewById(vn.bhxh.bhxhmail.R.id.crypto_info_top_icon_3);
        topText = (TextView) dialogView.findViewById(vn.bhxh.bhxhmail.R.id.crypto_info_top_text);

        bottomIconFrame = dialogView.findViewById(vn.bhxh.bhxhmail.R.id.crypto_info_bottom_frame);
        bottomIcon_1 = (ImageView) bottomIconFrame.findViewById(vn.bhxh.bhxhmail.R.id.crypto_info_bottom_icon_1);
        bottomIcon_2 = (ImageView) bottomIconFrame.findViewById(vn.bhxh.bhxhmail.R.id.crypto_info_bottom_icon_2);
        bottomText = (TextView) dialogView.findViewById(vn.bhxh.bhxhmail.R.id.crypto_info_bottom_text);
        ...
        b.setPositiveButton(vn.bhxh.bhxhmail.R.string.crypto_info_ok, new OnClickListener() {
            @Override
        ...
        if (displayStatus.hasAssociatedKey()) {
            b.setNeutralButton(vn.bhxh.bhxhmail.R.string.crypto_info_view_key, new OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
