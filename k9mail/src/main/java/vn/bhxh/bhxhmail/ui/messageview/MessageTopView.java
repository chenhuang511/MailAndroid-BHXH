...
import vn.bhxh.bhxhmail.Account.ShowPictures;
...
import vn.bhxh.bhxhmail.view.ToolableViewAnimator;
...
public class MessageTopView extends LinearLayout {
    ...
    public void onFinishInflate() {
        ...
        mHeaderContainer = (MessageHeader) findViewById(vn.bhxh.bhxhmail.R.id.header_container);
        // mHeaderContainer.setOnLayoutChangedListener(this);
        mInflater = LayoutInflater.from(getContext());

        viewAnimator = (ToolableViewAnimator) findViewById(vn.bhxh.bhxhmail.R.id.message_layout_animator);
        progressBar = (ProgressBar) findViewById(vn.bhxh.bhxhmail.R.id.message_progress);
        progressText = (TextView) findViewById(vn.bhxh.bhxhmail.R.id.message_progress_text);

        mDownloadRemainder = (Button) findViewById(vn.bhxh.bhxhmail.R.id.download_remainder);
        mDownloadRemainder.setVisibility(View.GONE);

        showPicturesButton = (Button) findViewById(vn.bhxh.bhxhmail.R.id.show_pictures);
    ...
    public void showMessage(Account account, MessageViewInfo messageViewInfo) {
        ...
        MessageContainerView view = (MessageContainerView) mInflater.inflate(vn.bhxh.bhxhmail.R.layout.message_container,
                containerView, false);
    ...
    public void showMessageCryptoWarning(final MessageViewInfo messageViewInfo, Drawable providerIcon,
        ...
        resetAndPrepareMessageView(messageViewInfo);
        View view = mInflater.inflate(vn.bhxh.bhxhmail.R.layout.message_content_crypto_warning, containerView, false);
        setCryptoProviderIcon(providerIcon, view);

        view.findViewById(vn.bhxh.bhxhmail.R.id.crypto_warning_override).setOnClickListener(new OnClickListener() {
            @Override
        ...
        TextView warningText = (TextView) view.findViewById(vn.bhxh.bhxhmail.R.id.crypto_warning_text);
    ...
    public void showMessageEncryptedButIncomplete(MessageViewInfo messageViewInfo, Drawable providerIcon) {
        resetAndPrepareMessageView(messageViewInfo);
        View view = mInflater.inflate(vn.bhxh.bhxhmail.R.layout.message_content_crypto_incomplete, containerView, false);
        setCryptoProviderIcon(providerIcon, view);
    ...
    public void showMessageCryptoErrorView(MessageViewInfo messageViewInfo, Drawable providerIcon) {
        resetAndPrepareMessageView(messageViewInfo);
        View view = mInflater.inflate(vn.bhxh.bhxhmail.R.layout.message_content_crypto_error, containerView, false);
        setCryptoProviderIcon(providerIcon, view);

        TextView cryptoErrorText = (TextView) view.findViewById(vn.bhxh.bhxhmail.R.id.crypto_error_text);
    ...
    public void showMessageCryptoCancelledView(MessageViewInfo messageViewInfo, Drawable providerIcon) {
        resetAndPrepareMessageView(messageViewInfo);
        View view = mInflater.inflate(vn.bhxh.bhxhmail.R.layout.message_content_crypto_cancelled, containerView, false);
        setCryptoProviderIcon(providerIcon, view);

        view.findViewById(vn.bhxh.bhxhmail.R.id.crypto_cancelled_retry).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void setCryptoProviderIcon(Drawable openPgpApiProviderIcon, View view) {
        ImageView cryptoProviderIcon = (ImageView) view.findViewById(vn.bhxh.bhxhmail.R.id.crypto_error_icon);
        if (openPgpApiProviderIcon != null) {
            cryptoProviderIcon.setImageDrawable(openPgpApiProviderIcon);
        } else {
            cryptoProviderIcon.setImageResource(vn.bhxh.bhxhmail.R.drawable.status_lock_error);
            cryptoProviderIcon.setColorFilter(ThemeUtils.getStyledColor(getContext(), vn.bhxh.bhxhmail.R.attr.openpgp_red));
        }
    }
