...
import vn.bhxh.bhxhmail.activity.UpgradeDatabases;
...
import vn.bhxh.bhxhmail.preferences.GlobalSettings;
import vn.bhxh.bhxhmail.preferences.Storage;
import vn.bhxh.bhxhmail.preferences.StorageEditor;
import vn.bhxh.bhxhmail.provider.UnreadWidgetProvider;
import vn.bhxh.bhxhmail.service.BootReceiver;
import vn.bhxh.bhxhmail.service.MailService;
import vn.bhxh.bhxhmail.service.ShutdownReceiver;
import vn.bhxh.bhxhmail.service.StorageGoneReceiver;
...
public class K9 extends Application {
    ...
    public static final String FOLDER_ATTACH = "BHXH_MAIL";
     ...
     * was called.
     * Afterwards calls to {@link #registerApplicationAware(K9.ApplicationAware)} will
     * immediately call {@link K9.ApplicationAware#initializeComponent(K9)} for the
     * supplied argument.
     */
    ...
    public static void loadPrefs(Preferences prefs) {
        ...
        File file = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString(), FOLDER_ATTACH);
        if (!file.exists()) {
            file.mkdirs();
        }
        mAttachmentDefaultPath = storage.getString("attachmentdefaultpath",
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() + "/" + FOLDER_ATTACH + "/");
