...
import vn.bhxh.bhxhmail.cache.EmailProviderCacheCursor;
...
import vn.bhxh.bhxhmail.mailstore.LockableDatabase;
...
public class EmailProvider extends ContentProvider {
    ...
    protected Cursor getMessages(String accountUuid, final String[] projection,
        ...
        try {
            return database.execute(false, new LockableDatabase.DbCallback<Cursor>() {
                @Override
                public Cursor doDbWork(SQLiteDatabase db) throws LockableDatabase.WrappedException,
