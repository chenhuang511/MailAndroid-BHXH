package vn.bhxh.bhxhmail.mail.store.webdav;
...
public class WebDavStoreTest {
    ...
    public void createUri_withSetting_shouldProvideUri() {
        ServerSettings serverSettings = new ServerSettings(ServerSettings.Type.WebDAV, "example.org", 123456, ConnectionSecurity.NONE,
    ...
    public void createUri_withSettingsWithTLS_shouldProvideSSLUri() {
        ServerSettings serverSettings = new ServerSettings(ServerSettings.Type.WebDAV, "example.org", 123456,
    ...
    public void checkSettings_withInitialUnauthorizedResponse_shouldPerformBasicAuthentication() throws Exception {
        ...
        Assert.assertEquals("Basic " + Base64.encode("user:password"),
