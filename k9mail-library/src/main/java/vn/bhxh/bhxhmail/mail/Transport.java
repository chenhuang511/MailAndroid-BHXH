...
import vn.bhxh.bhxhmail.mail.transport.SmtpTransport;
import vn.bhxh.bhxhmail.mail.transport.WebDavTransport;
...
public abstract class Transport {
    ...
    public static String createTransportUri(ServerSettings server) {
        ...
        } else if (ServerSettings.Type.WebDAV == server.type) {
